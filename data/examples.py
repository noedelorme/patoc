...
org1 = circuit2.gate("in", pos=(0,0), org=True)
org2 = circuit2.gate("in", pos=(0,1), org=True)
org3 = circuit2.gate("in", pos=(0,2), org=True)
org4 = circuit2.gate("in", pos=(0,3), org=True)
h1 = circuit2.gate("H", pos=(1,1))
a = circuit2.gate("A", dom=2, pos=(1,[2,3]))
h2 = circuit2.gate("H", pos=(2,2))
p = circuit2.gate("P", dom=3, pos=(3,[1,2,3]))
b = circuit2.gate("B", dom=2, pos=(4,[0,1]))
h3 = circuit2.gate("H", pos=(4,2))
u = circuit2.gate("U", dom=2, pos=(5,[1,2]))
h4 = circuit2.gate("H", pos=(6,2))
dst1 = circuit2.gate("out", pos=(7,0), dst=True)
dst2 = circuit2.gate("out", pos=(7,1), dst=True)
dst3 = circuit2.gate("out", pos=(7,2), dst=True)
dst4 = circuit2.gate("out", pos=(7,3), dst=True)
