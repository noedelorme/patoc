...
class MainWindow:
    def __init__(self) -> None:
        ...
        org4 = Gate(3,"in", pos=(0,3))
        h1 = Gate(4,"H", pos=(1,1))
        a = Gate(5,"A", arity=2, pos=(1,[2,3]))
        h2 = Gate(6,"H", pos=(2,2))
        cx1 = Gate(7,"CNOT", pos=(3,[1,2]))
        h3 = Gate(8,"H", pos=(4,2))
        b = Gate(9,"B", arity=2, pos=(4,[0,1]))
        cx2 = Gate(10,"CNOT", pos=(5,[1,2]))
        dst1 = Gate(11,"out", pos=(6,0))
        dst2 = Gate(12,"out", pos=(6,1))
        dst3 = Gate(13,"out", pos=(6,2))
        dst4 = Gate(14,"out", pos=(6,3))
        circuit = Circuit("My circuit", [org1,org2,org3,org4,h1,a,h2,cx1,h3,b,cx2,dst1,dst2,dst3,dst4],[0,1,2,3])
        ...
        CZorg1 = Gate(0,"in", pos=(0,0))
        CZorg2 = Gate(1,"in", pos=(0,1))
        CZh1 = Gate(2,"H", pos=(1,1))
        CZcx1 = Gate(3,"CNOT", pos=(2,[0,1]))
        CZh2 = Gate(4,"H", pos=(3,1))
        CZdst1 = Gate(5,"out", pos=(4,0))
        CZdst2 = Gate(6,"out", pos=(4,1))
        axiom = Circuit("cz-one-cnot", [CZorg1,CZorg2,CZh1,CZcx1,CZh2,CZdst1,CZdst2],[0,1])
